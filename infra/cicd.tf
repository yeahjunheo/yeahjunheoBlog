...
resource "google_iam_workload_identity_pool_provider" "github" {
  ...
  attribute_condition = "assertion.repository_owner == \"yeahjunheo\""
...
resource "google_service_account_iam_member" "github_actions_wif" {
  ...
  member             = "principalSet://iam.googleapis.com/${google_iam_workload_identity_pool.github.name}/attribute.repository/yeahjunheo/yeahjunheoBlog"
}
